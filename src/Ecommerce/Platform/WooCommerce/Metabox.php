...
class Metabox
{
    ...
    {
        if (!\array_key_exists('post_type', $_POST) || $_POST['post_type'] !== 'product' || !\array_key_exists('ukiyo_wpnonce', $_POST) || !\wp_verify_nonce($_POST['ukiyo_wpnonce'], UKIYO::WP_OPTION)) {
            return;
        }
        ...
        \update_post_meta($postId, 'ukiyo_max_sites', (int) isset($_POST['ukiyo_max_sites']) && $_POST['ukiyo_max_sites'] > 0 ? $_POST['ukiyo_max_sites'] : 0);
        \update_post_meta($postId, 'ukiyo_active_duration', (int) isset($_POST['ukiyo_active_duration']) && $_POST['ukiyo_active_duration'] > 0 ? $_POST['ukiyo_active_duration'] : 0);
    }
    private function render_metabox(WP_Post $wpPost) : void
    {
        $nonce_field = \wp_nonce_field(UKIYO::WP_OPTION, 'ukiyo_wpnonce', \false, \false);
    ...
    <div class="ukiyo-container">
        ...
        <div>
            ...
            <label for="ukiyo_should_generate">
                <input type="checkbox" name="ukiyo_should_generate" id="ukiyo_should_generate" {$should_generate} >
        ...
        <div>
            ...
            <label for="ukiyo_should_renewal">
                <input type="checkbox" name="ukiyo_should_renewal" id="ukiyo_should_renewal" {$should_renewal}>
        ...
        <div>
            ...
            <input type="number" name="ukiyo_max_sites" id="ukiyo_max_sites" value="{$max_sites}" min="0" style="max-width: 100%;">
        </div>
        ...
        <div>
            ...
            <div>
                <input type="number" name="ukiyo_active_duration" id="ukiyo_active_duration" value="{$active_duration}" min="0" style="max-width: 100%;">
                 days
            </div>
            </label>
        </div>
