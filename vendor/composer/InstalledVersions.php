 ...
 */
namespace _YabeUkiyo\Composer;

use _YabeUkiyo\Composer\Autoload\ClassLoader;
use _YabeUkiyo\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_YabeUkiyo\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
